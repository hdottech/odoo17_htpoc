...
class SafetyOperationController(http.Controller):
    @http.route(['/safety_operation_2'], type='http', auth="public", website=True)
    def safety_operation_form(self, **kw):
        try:
            ...
            return request.render('approval_website.safety_form_template_2', values)
    ...
    @http.route(['/safety_operation_2/submit'], type='http', auth="public", website=True, csrf=False, methods=['POST'])
